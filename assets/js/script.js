...
//toggle footer menu script
function toggleFooterMenu(event, footerMenuName) {
    if(document.documentElement.clientWidth < 710) {
        let currentfooterMenuName = document.getElementById(footerMenuName);
      
        if(currentfooterMenuName.style.display === "block") {
          currentfooterMenuName.style.display = "none";
        } else {
          currentfooterMenuName.style.display = "block";
        }
    }
};

function resizeFunction() {
    let filterMenu = document.querySelector(".footerMenuBox");
    if (document.documentElement.clientWidth > 710) {
